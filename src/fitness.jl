...
function test_fitness_of_generator(gen::AbstractGenerator; rng::AbstractRNG=MersenneTwister(), samples::Int = 25, threshold::Float64 = 0.95)
  mean_q = 0.0
  mean_s = 0.0
  success = 0
  ...
  for i = 1:samples
    ...
    net = generate( gen, seed = int(rand(rng)*10000) )
