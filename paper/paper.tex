...
between sparse random connections and a ring topology where
...
$\gain = 1.5$ and $\feedback = 2$ are kept constant during the optimization process,
...
a good choice of network parameters is able to improve the success rate for
certain frequency ranges. Some parameters ($\ERprob$, $\feedback$) can vary in a relatively large interval
